export default function DashBoard() {
  return (
    // <div classNameName="fixed top-0 left-0 w-full z-50 bg-white border-b backdrop-blur-lg bg-opacity-80">
    //   <div classNameName="mx-auto px-6 sm:px-6 lg:px-8 ">
    //     <div classNameName="relative flex h-16 justify-between">
    //       <div classNameName="flex flex-1 items-stretch justify-start">
    //         <a classNameName="flex flex-shrink-0 items-center" href="#">
    //           <img
    //             classNameName="block h-auto w-24"
    //             src="logo.png"
    //           />
    //         </a>
    //       </div>
    //       <div classNameName="flex-shrink-0 flex px-2 py-3 items-center space-x-8">
    //         <a
    //           classNameName="text-gray-700 hover:text-sky-700 text-sm font-medium"
    //           href="#"
    //         >
    //           Login
    //         </a>
